...
void __ISR(_UART1_RX_VECTOR, ipl1AUTO) _IntHandlerDrvUsartReceiveInstance0(void)
{
    ...
    putItem(&appData.rxRingBuffer, DRV_USART_ReadByte(appData.usartHandle));
...
void __ISR(_SPI3_RX_VECTOR, ipl1AUTO) _IntHandlerSPIRxInstance1(void)
{
